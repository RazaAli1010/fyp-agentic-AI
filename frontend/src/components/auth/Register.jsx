        ...
        >
          <div className="p-8 sm:p-10">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <motion.div
                animate={
                  errors.username && touched.username ? shakeAnimation : {}
                }
              >
                <label
                  htmlFor="username"
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className={`appearance-none block w-full pl-12 pr-12 py-3.5 border-2 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-0 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
              ...
              {/* Email Input */}
              <motion.div
                animate={errors.email && touched.email ? shakeAnimation : {}}
              >
                <label
                  htmlFor="email"
                  className="block text-sm font-semibold text-gray-700 mb-2"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                {/* Name Input */}
                <motion.div
                  animate={errors.name && touched.name ? shakeAnimation : {}}
                >
                  <label
                    htmlFor="name"
                    className="block text-sm font-semibold text-gray-700 mb-2"
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      disabled={isLoading}
                      className={`appearance-none block w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-0 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
              ...
              <motion.div
                animate={
                  errors.password && touched.password ? shakeAnimation : {}
                }
              >
                <label
                  htmlFor="password"
